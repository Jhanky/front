    ...
    <Card extra={"w-full p-4 h-full"}>
      <div className="mb-8 w-full">
        ...
        <p className="mt-2 text-base text-gray-600">
          Aquí puedes encontrar más detalles sobre tus proyectos. Mantén a tu usuario
          comprometido proporcionando información significativa.
        </p>
      </div>
      {/* Project 1 */}
        ...
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <p className="text-base font-medium text-navy-700 dark:text-white">
              Tecnología detrás del Blockchain
            </p>
